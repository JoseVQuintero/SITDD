...
<head>
  ...
  <meta name="description" content="RED - Inicio -" />
  <title>Instituto Sudcaliforniano del Deporte - Registro Estatal del Deporte</title>
		...
		<div class="padding">
			<div id="element-box" class="login">
				...
				<div class="m">
					...
					<h1>Acceso Registro Estatal del Deporte</h1>
